        ...
        <div class="row gallery-section">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card shadow gallery-item">
                    <img src="image 1 web.jpg" class="card-img-top gallery-img">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card shadow gallery-item">
                    <img src="image 2 web.jpg" class="card-img-top gallery-img">
                    <div class="card-body text-center">
                        <p class="card-title">MAKEUP KID</p> 
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card shadow gallery-item">
                    <img src="image 5 web.jpg" class="card-img-top gallery-img">
                    <div class="card-body text-center">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card shadow gallery-item">
                    <img src="image 4 web.jpg" class="card-img-top gallery-img">
                    <div class="card-body text-center">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card shadow gallery-item">
                    <img src="image 6 web.jpg" class="card-img-top gallery-img">
                    <div class="card-body text-center">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card shadow gallery-item">
                    <img src="image 7 web.jpg" class="card-img-top gallery-img">
                    <div class="card-body text-center">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card shadow gallery-item">
                    <img src="image 8 web.jpg" class="card-img-top gallery-img">
                    <div class="card-body text-center">
                        <p class="card-title">SKINCARE PRODUCTS</p>
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card shadow gallery-item">
                    <img src="image 3 web.jpg" class="card-img-top gallery-img">
                    <div class="card-body text-center">
...
## RESULT:
The Project for responsive web design using Bootstrap is completed success.